...
# excelファイルの内容を読み込み
df = pd.read_excel('S:/個人作業用/渡邊/ワールドジャパン/学習用データ/サロンカルテデータ_相馬さん/2フォーマット(潮永さん）/【E】エステティックサービス契約書.xlsx', sheet_name='【E】エステティックサービス契約書', header=1)
